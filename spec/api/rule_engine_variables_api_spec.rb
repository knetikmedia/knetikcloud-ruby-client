...
# Unit tests for KnetikCloudClient::RuleEngineVariablesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RuleEngineVariablesApi' do
  before do
    # run before each test
    @instance = KnetikCloudClient::RuleEngineVariablesApi.new
  end
  ...
  describe 'test an instance of RuleEngineVariablesApi' do
    it 'should create an instance of RuleEngineVariablesApi' do
      expect(@instance).to be_instance_of(KnetikCloudClient::RuleEngineVariablesApi)
    end
  end
