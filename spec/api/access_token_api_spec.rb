...
# Unit tests for SwaggerClient::AccessTokenApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccessTokenApi' do
  before do
    # run before each test
    @instance = SwaggerClient::AccessTokenApi.new
  end
  ...
  describe 'test an instance of AccessTokenApi' do
    it 'should create an instact of AccessTokenApi' do
      expect(@instance).to be_instance_of(SwaggerClient::AccessTokenApi)
    end
  end
