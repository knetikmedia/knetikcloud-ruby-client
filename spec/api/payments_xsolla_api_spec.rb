...
describe 'PaymentsXsollaApi' do
  ...
  # unit tests for create_token_url_using_post
  # Create a payment token that should be used to forward the user to Xsolla so they can complete payment
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [XsollaPaymentRequest] :request The payment request to be sent to XSolla
  # @return [String]
  describe 'create_token_url_using_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for receive_notification_using_post
  # Receives payment response from Xsolla
  # Only used by XSolla to call back to JSAPI after processing user payment action
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'receive_notification_using_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
