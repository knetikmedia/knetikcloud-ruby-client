...
describe 'LocationsApi' do
  ...
  describe 'get_cities test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_countries1
  # Get a list of countries
  # 
  # @param [Hash] opts the optional parameters
  # @return [Array<CountryResource>]
  describe 'get_countries1 test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_countries2
  # Get a list of a country&#39;s states
  # 
  # @param country_code_iso3 The iso3 code of the country
  # @param [Hash] opts the optional parameters
  # @return [Array<StateResource>]
  describe 'get_countries2 test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
