...
describe 'StoreApi' do
  ...
  # @option opts [ItemTemplateResource] :item_template_resource The new item template
  ...
  # @param id The id of the template
  # @param [Hash] opts the optional parameters
  # @option opts [ItemTemplateResource] :item_template_resource The item template resource object
  # @return [nil]
