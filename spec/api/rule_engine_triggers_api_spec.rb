...
# Unit tests for KnetikCloudClient::RuleEngineTriggersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RuleEngineTriggersApi' do
  before do
    # run before each test
    @instance = KnetikCloudClient::RuleEngineTriggersApi.new
  end
  ...
  describe 'test an instance of RuleEngineTriggersApi' do
    it 'should create an instance of RuleEngineTriggersApi' do
      expect(@instance).to be_instance_of(KnetikCloudClient::RuleEngineTriggersApi)
    end
  end
