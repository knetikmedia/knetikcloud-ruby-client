...
# Unit tests for KnetikCloudClient::BRERuleEngineRulesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BRERuleEngineRulesApi' do
  before do
    # run before each test
    @instance = KnetikCloudClient::BRERuleEngineRulesApi.new
  end
  ...
  describe 'test an instance of BRERuleEngineRulesApi' do
    it 'should create an instance of BRERuleEngineRulesApi' do
      expect(@instance).to be_instance_of(KnetikCloudClient::BRERuleEngineRulesApi)
    end
  end
