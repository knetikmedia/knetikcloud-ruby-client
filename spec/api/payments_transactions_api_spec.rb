...
# Unit tests for SwaggerClient::PaymentsTransactionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentsTransactionsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::PaymentsTransactionsApi.new
  end
  ...
  describe 'test an instance of PaymentsTransactionsApi' do
    it 'should create an instact of PaymentsTransactionsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::PaymentsTransactionsApi)
    end
  end

  # unit tests for get_transaction_using_get
  # Get the details for a single transaction
  # 
  # @param id id
  # @param [Hash] opts the optional parameters
  # @return [TransactionResource]
  describe 'get_transaction_using_get test' do
    it "should work" do
  ...
  # unit tests for refund_transaction_using_post
  ...
  describe 'refund_transaction_using_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
