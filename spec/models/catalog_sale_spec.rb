...
# Unit tests for KnetikCloudClient::CatalogSale
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CatalogSale' do
  before do
    # run before each test
    @instance = KnetikCloudClient::CatalogSale.new
  end
  ...
  describe 'test an instance of CatalogSale' do
    it 'should create an instance of CatalogSale' do
      expect(@instance).to be_instance_of(KnetikCloudClient::CatalogSale)
    end
  end
