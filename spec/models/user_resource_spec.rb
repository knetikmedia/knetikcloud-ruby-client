...
# Unit tests for KnetikCloudClient::UserResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserResource' do
  before do
    # run before each test
    @instance = KnetikCloudClient::UserResource.new
  end
  ...
  describe 'test an instance of UserResource' do
    it 'should create an instact of UserResource' do
      expect(@instance).to be_instance_of(KnetikCloudClient::UserResource)
    end
  end
