...
# Unit tests for SwaggerClient::ActivityUserResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ActivityUserResource' do
  before do
    # run before each test
    @instance = SwaggerClient::ActivityUserResource.new
  end
  ...
  describe 'test an instance of ActivityUserResource' do
    it 'should create an instact of ActivityUserResource' do
      expect(@instance).to be_instance_of(SwaggerClient::ActivityUserResource)
    end
  end
