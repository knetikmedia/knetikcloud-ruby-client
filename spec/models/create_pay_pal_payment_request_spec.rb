...
# Unit tests for SwaggerClient::CreatePayPalPaymentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreatePayPalPaymentRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::CreatePayPalPaymentRequest.new
  end
  ...
  describe 'test an instance of CreatePayPalPaymentRequest' do
    it 'should create an instact of CreatePayPalPaymentRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::CreatePayPalPaymentRequest)
    end
  end
