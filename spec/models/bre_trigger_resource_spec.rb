...
# Unit tests for KnetikCloudClient::BreTriggerResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BreTriggerResource' do
  before do
    # run before each test
    @instance = KnetikCloudClient::BreTriggerResource.new
  end
  ...
  describe 'test an instance of BreTriggerResource' do
    it 'should create an instance of BreTriggerResource' do
      expect(@instance).to be_instance_of(KnetikCloudClient::BreTriggerResource)
    end
  end
