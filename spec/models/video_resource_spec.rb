...
# Unit tests for KnetikCloudClient::VideoResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VideoResource' do
  before do
    # run before each test
    @instance = KnetikCloudClient::VideoResource.new
  end
  ...
  describe 'test an instance of VideoResource' do
    it 'should create an instance of VideoResource' do
      expect(@instance).to be_instance_of(KnetikCloudClient::VideoResource)
    end
  end
