...
# Unit tests for SwaggerClient::PageConfig
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PageConfig' do
  before do
    # run before each test
    @instance = SwaggerClient::PageConfig.new
  end
  ...
  describe 'test an instance of PageConfig' do
    it 'should create an instact of PageConfig' do
      expect(@instance).to be_instance_of(SwaggerClient::PageConfig)
    end
  end
