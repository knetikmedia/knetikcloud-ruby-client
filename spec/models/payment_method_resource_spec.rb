...
# Unit tests for KnetikCloudClient::PaymentMethodResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentMethodResource' do
  before do
    # run before each test
    @instance = KnetikCloudClient::PaymentMethodResource.new
  end
  ...
  describe 'test an instance of PaymentMethodResource' do
    it 'should create an instact of PaymentMethodResource' do
      expect(@instance).to be_instance_of(KnetikCloudClient::PaymentMethodResource)
    end
  end
