...
# Unit tests for KnetikCloudClient::Topic
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Topic' do
  before do
    # run before each test
    @instance = KnetikCloudClient::Topic.new
  end
  ...
  describe 'test an instance of Topic' do
    it 'should create an instance of Topic' do
      expect(@instance).to be_instance_of(KnetikCloudClient::Topic)
    end
  end
  ...
  describe 'test attribute "topic_map"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
