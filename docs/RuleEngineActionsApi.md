# KnetikCloudClient::RuleEngineActionsApi
...
api_instance = KnetikCloudClient::RuleEngineActionsApi.new
...
begin
  ...
  puts "Exception when calling RuleEngineActionsApi->get_bre_actions: #{e}"
end
```
