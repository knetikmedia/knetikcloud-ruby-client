...
**max_value** | **Integer** | The maximum value for the achievement definition. Must be greater than or equal to min_value. | 
**min_value** | **Integer** | The minimum value for the achievement definition. Must be greater than zero. | 
