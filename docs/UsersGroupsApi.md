...
> PageTemplateResource get_group_templates_using_get(opts)
...
> PageGroupMemberResource search_groups_using_get(unique_name, opts)
...
> PageGroupResource search_groups_using_get1(opts)
