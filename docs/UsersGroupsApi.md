...
begin
  ...
  puts "Exception when calling UsersGroupsApi->delete_group_member_using_delete: #{e}"
end
```
...
> Array&lt;String&gt; get_group_list_using_get(user_id)
...
begin
  #List groups a user is in
  result = api_instance.get_group_list_using_get(user_id)
  p result
rescue SwaggerClient::ApiError => e
  puts "Exception when calling UsersGroupsApi->get_group_list_using_get: #{e}"
end
```
...
begin
  #Get a user from a group
  result = api_instance.get_group_member_using_get(unique_name, user_id)
  p result
rescue SwaggerClient::ApiError => e
  puts "Exception when calling UsersGroupsApi->get_group_member_using_get: #{e}"
end
```
