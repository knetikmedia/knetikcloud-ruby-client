...
# **set_client_roles**
> set_client_roles(client_key, opts)
...
begin
  #Set roles for a client
  api_instance.set_client_roles(client_key, opts)
rescue SwaggerClient::ApiError => e
...
> set_permissions_for_role(role, opts)
...
begin
  #Set permissions for a role
  api_instance.set_permissions_for_role(role, opts)
rescue SwaggerClient::ApiError => e
...
begin
  #Set roles for a user
  api_instance.set_user_roles(user_id, opts)
rescue SwaggerClient::ApiError => e
...
begin
  #Update a role
  api_instance.update_role(role, opts)
rescue SwaggerClient::ApiError => e
