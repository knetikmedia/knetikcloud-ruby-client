# SwaggerClient::BreEventLog

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**customer** | **String** | The customer of the BRE event log | [optional] 
**event_id** | **Integer** | The event id of the BRE event log | [optional] 
**event_name** | **String** | The event name of the BRE event log | [optional] 
**event_start_date** | **Integer** | The event start date of the BRE event log | [optional] 
