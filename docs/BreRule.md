...
**evaluation_count** | **Integer** | How many times the rule has been evaluated (it&#39;s conditions checked, whether it then runs or not) | [optional] 
...
**run_count** | **Integer** | How many times the rule has run | [optional] 
