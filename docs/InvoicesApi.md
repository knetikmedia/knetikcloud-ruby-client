...
> PageInvoiceResource get_invoice_history_using_get(opts)
...
> InvoiceResource get_invoice_using_get(id, opts)
...
opts = { 
  postal_code: "postal_code_example" # String | The postal code of the invoice or 'none'.
}

begin
  #Retrieve an invoice
  result = api_instance.get_invoice_using_get(id, opts)
  p result
rescue SwaggerClient::ApiError => e
...
# **get_logs_using_get**
> PageInvoiceLogEntry get_logs_using_get(id, opts)
