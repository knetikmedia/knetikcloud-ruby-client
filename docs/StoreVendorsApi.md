...
opts = { 
  vendor_template_resource: SwaggerClient::ItemTemplateResource.new # ItemTemplateResource | The new vendor template
}
...
opts = { 
  vendor_template_resource: SwaggerClient::ItemTemplateResource.new # ItemTemplateResource | The vendor template resource object
}
