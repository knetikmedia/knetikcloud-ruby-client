...
> StoreItemTemplateResource create_item_template_using_post(opts)
...
> PageResourceStoreItemTemplateResource get_item_templates_using_get(opts)
...
> PageResourceStoreItem get_store_items_using_get(opts)
...
# **get_using_get2**
> PageResourceStoreItem get_using_get2(opts)
