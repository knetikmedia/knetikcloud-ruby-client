...
> PageResourceTemplateResource get_achievement_templates_using_get(opts)
...
> PageResourceAchievementDefinitionResource get_achievements_using_get(opts)
...
> PageResourceUserAchievementGroupResource get_all_user_progress_for_achievement_using_get(achievement_name, opts)
...
> PageResourceUserAchievementGroupResource get_all_user_progress_using_get(opts)
...
> PageResourceUserAchievementGroupResource get_user_progress_using_get(user_id, opts)
