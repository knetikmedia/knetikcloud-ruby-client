...
begin
  #Update an achievement definition
  api_instance.update_achievement(name, opts)
rescue SwaggerClient::ApiError => e
...
> UserAchievementGroupResource update_achievement_progress(user_id, achievement_name, opts)
...
begin
  #Update or create an achievement progress record for a user
  result = api_instance.update_achievement_progress(user_id, achievement_name, opts)
  p result
rescue SwaggerClient::ApiError => e
  puts "Exception when calling GamificationAchievementsApi->update_achievement_progress: #{e}"
end
```
...
> update_achievement_template(id, opts)
...
begin
  #Update an achievement template
  api_instance.update_achievement_template(id, opts)
rescue SwaggerClient::ApiError => e
