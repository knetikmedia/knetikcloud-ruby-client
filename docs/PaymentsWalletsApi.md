...
> PageResourceSimpleWallet get_wallets_using_get1(opts)
...
> PageResourceWalletTransactionResource transaction_history_using_get(opts)
...
> PageResourceWalletTransactionResource user_transaction_history_using_get(user_id, currency_code, opts)
