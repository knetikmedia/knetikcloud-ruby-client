# SwaggerClient::SocialFacebookApi
...
api_instance = SwaggerClient::SocialFacebookApi.new

opts = { 
  facebook_token: SwaggerClient::FacebookToken.new # FacebookToken | The token from facebook
}
