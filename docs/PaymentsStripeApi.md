...
> PaymentMethodResource create_customer_using_post(opts)
...
begin
  #Create a Stripe payment method for a user
  result = api_instance.create_customer_using_post(opts)
  p result
rescue SwaggerClient::ApiError => e
  puts "Exception when calling PaymentsStripeApi->create_customer_using_post: #{e}"
end
```
