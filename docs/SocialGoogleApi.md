...
api_instance = SwaggerClient::SocialGoogleApi.new

opts = { 
  facebook_token: SwaggerClient::GoogleToken.new # GoogleToken | The token from facebook
}
