...
begin
  #Update a category
  api_instance.update_bre_category(name, opts)
rescue SwaggerClient::ApiError => e
...
> update_bre_category_template(id, opts)
...
begin
  #Update a BRE category template
  api_instance.update_bre_category_template(id, opts)
rescue SwaggerClient::ApiError => e
