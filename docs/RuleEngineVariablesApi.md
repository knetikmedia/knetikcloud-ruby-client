# KnetikCloudClient::RuleEngineVariablesApi
...
api_instance = KnetikCloudClient::RuleEngineVariablesApi.new
...
begin
  ...
  puts "Exception when calling RuleEngineVariablesApi->get_bre_variable_types: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling RuleEngineVariablesApi->get_bre_variable_values: #{e}"
end
```
