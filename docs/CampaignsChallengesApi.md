...
opts = { 
  filter_start_date_min: 789, # Integer | events starting after this date, unix timestamp in seconds
  filter_start_date_max: 789, # Integer | events starting before this date, unix timestamp in seconds
  filter_end_date_min: 789, # Integer | events ending after this date, unix timestamp in seconds
  filter_end_date_max: 789, # Integer | events ending before this date, unix timestamp in seconds
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **filter_start_date_min** | **Integer**| events starting after this date, unix timestamp in seconds | [optional] 
 **filter_start_date_max** | **Integer**| events starting before this date, unix timestamp in seconds | [optional] 
 **filter_end_date_min** | **Integer**| events ending after this date, unix timestamp in seconds | [optional] 
 **filter_end_date_max** | **Integer**| events ending before this date, unix timestamp in seconds | [optional] 
