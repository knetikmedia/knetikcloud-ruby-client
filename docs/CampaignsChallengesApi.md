...
> PageResourceBareChallengeActivityResource get_activities_using_get1(challenge_id, opts)
...
> PageResourceChallengeEventResource get_challenge_eventss_using_get(opts)
...
> PageResourceTemplateResource get_challenge_templates_using_get(opts)
...
> PageResourceChallengeResource get_challenges_using_get1(opts)
