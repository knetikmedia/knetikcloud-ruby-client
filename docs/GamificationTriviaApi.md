...
# **get_list_using_get1**
> PageImportJobResource get_list_using_get1(opts)
...
> PageQuestionTemplateResource get_question_templates_using_get(opts)
...
> PageQuestionResource get_questions_using_get(opts)
