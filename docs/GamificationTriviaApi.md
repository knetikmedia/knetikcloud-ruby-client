...
# **get_question_tags1**
> Collectionstring get_question_tags1(opts)
...
begin
  #List and search tags by the beginning of the string
  result = api_instance.get_question_tags1(opts)
  p result
rescue SwaggerClient::ApiError => e
  puts "Exception when calling GamificationTriviaApi->get_question_tags1: #{e}"
end
```
...
> update_question_template(id, opts)
...
begin
  #Update a question template
  api_instance.update_question_template(id, opts)
rescue SwaggerClient::ApiError => e
