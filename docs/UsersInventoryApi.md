...
> PageResourceEntitlementItem get_currencies_using_get1(opts)
...
> PageResourceItemTemplateResource get_entitlement_templates_using_get(opts)
...
> PageResourceUserInventoryResource get_inventory_list_using_get(opts)
...
> PageResourceUserInventoryResource get_user_inventory_list_using_get(id, opts)
...
> PageResourceUserItemLogResource get_user_inventory_log_using_get(user_id, id, opts)
...
grant_request = SwaggerClient::EntitlementGrantRequest.new # EntitlementGrantRequest | grantRequest
...
begin
  ...
  puts "Exception when calling UsersInventoryApi->grant_entitlement_using_post: #{e}"
end
```
