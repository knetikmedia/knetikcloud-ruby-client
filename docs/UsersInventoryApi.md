...
# **get_user_inventory1**
> PageResourceUserInventoryResource get_user_inventory1(id, opts)
...
begin
  #List the user inventory entries for a given user
  result = api_instance.get_user_inventory1(id, opts)
  p result
rescue SwaggerClient::ApiError => e
  puts "Exception when calling UsersInventoryApi->get_user_inventory1: #{e}"
end
```
...
> get_user_inventory_log1(user_id, id, opts)
...
begin
  #Set the expiration date
  api_instance.get_user_inventory_log1(user_id, id, opts)
rescue SwaggerClient::ApiError => e
  puts "Exception when calling UsersInventoryApi->get_user_inventory_log1: #{e}"
end
```
...
> update_entitlement_template(id, opts)
...
begin
  #Update an entitlement template
  api_instance.update_entitlement_template(id, opts)
rescue SwaggerClient::ApiError => e
