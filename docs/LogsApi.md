...
> PageResourceBreEventLog get_events_logs_using_get(opts)
...
> PageResourceForwardLog get_forward_logs_using_get(opts)
...
> PageResourceUserActionLog get_user_logs_using_get1(opts)
