...
api_instance = KnetikCloudClient::CategoriesApi.new

opts = { 
  category: KnetikCloudClient::CategoryResource.new # CategoryResource | The category to create
}
...
opts = { 
  template: KnetikCloudClient::TemplateResource.new # TemplateResource | The template to create
}
...
opts = { 
  category: KnetikCloudClient::CategoryResource.new # CategoryResource | The category to update
}
...
opts = { 
  template: KnetikCloudClient::TemplateResource.new # TemplateResource | The updated template information
}
