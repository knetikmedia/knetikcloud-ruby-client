...
begin
  #Create a country tax
  api_instance.create_country_tax(opts)
...
# **create_state_tax**
> create_state_tax(country_code_iso3, opts)
...
begin
  #Create a state tax
  api_instance.create_state_tax(country_code_iso3, opts)
rescue SwaggerClient::ApiError => e
...
# **update_country_tax**
> update_country_tax(country_code_iso3, opts)
...
begin
  #Create or update a tax
  api_instance.update_country_tax(country_code_iso3, opts)
rescue SwaggerClient::ApiError => e
...
# **update_state_tax**
> update_state_tax(country_code_iso3, state_code, opts)
...
begin
  #Create or update a state tax
  api_instance.update_state_tax(country_code_iso3, state_code, opts)
rescue SwaggerClient::ApiError => e
