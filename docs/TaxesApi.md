...
> PageStateTaxResource get_all_taxes_using_get(opts)
...
# **get_taxes_using_get**
> PageCountryTaxResource get_taxes_using_get(opts)
...
> PageStateTaxResource get_taxes_using_get1(country_code_iso3, opts)
