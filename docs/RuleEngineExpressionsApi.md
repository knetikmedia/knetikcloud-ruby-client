# KnetikCloudClient::RuleEngineExpressionsApi
...
api_instance = KnetikCloudClient::RuleEngineExpressionsApi.new
...
begin
  ...
  puts "Exception when calling RuleEngineExpressionsApi->get_bre_expression: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling RuleEngineExpressionsApi->get_bre_expressions: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling RuleEngineExpressionsApi->get_expression_as_text: #{e}"
end
```
