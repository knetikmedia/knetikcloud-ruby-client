...
> PageSubscriptionTemplateResource get_subscription_templates_using_get(opts)
...
begin
  ...
  puts "Exception when calling StoreSubscriptionsApi->list_billing_reports_using_get: #{e}"
end
```
...
> PageSubscriptionResource list_subscriptions_using_get(opts)
