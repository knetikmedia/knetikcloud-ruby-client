...
api_instance = KnetikCloudClient::StoreSubscriptionsApi.new

opts = { 
  subscription_resource: KnetikCloudClient::SubscriptionResource.new # SubscriptionResource | The subscription to be created
}
...
opts = { 
  subscription_template_resource: KnetikCloudClient::SubscriptionTemplateResource.new # SubscriptionTemplateResource | The new subscription template
}
...
opts = { 
  subscription_resource: KnetikCloudClient::SubscriptionResource.new # SubscriptionResource | The subscription resource object
}
...
opts = { 
  subscription_template_resource: KnetikCloudClient::SubscriptionTemplateResource.new # SubscriptionTemplateResource | The subscription template resource object
}

begin
  #Update a subscription template
  result = api_instance.update_subscription_template(id, opts)
  p result
rescue KnetikCloudClient::ApiError => e
