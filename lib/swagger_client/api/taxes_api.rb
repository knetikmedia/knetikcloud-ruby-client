...
module SwaggerClient
  class TaxesApi
    ...
    def create_country_tax(opts = {})
      create_country_tax_with_http_info(opts)
      return nil
    end
    ...
    def create_state_tax(country_code_iso3, opts = {})
      create_state_tax_with_http_info(country_code_iso3, opts)
      return nil
    end
    ...
    def update_country_tax(country_code_iso3, opts = {})
      update_country_tax_with_http_info(country_code_iso3, opts)
      return nil
    end
    ...
    def update_state_tax(country_code_iso3, state_code, opts = {})
      update_state_tax_with_http_info(country_code_iso3, state_code, opts)
      return nil
    end
