...
module SwaggerClient
  class StoreVendorsApi
    ...
    def create_vendor_template_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/vendors/templates".sub('{format}','json')
    ...
    def delete_vendor_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling StoreVendorsApi.delete_vendor" if id.nil?
      # resource path
    ...
    def delete_vendor_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling StoreVendorsApi.delete_vendor_template" if id.nil?
      # resource path
      local_var_path = "/vendors/templates/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def get_vendor_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling StoreVendorsApi.get_vendor" if id.nil?
      # resource path
      local_var_path = "/vendors/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def get_vendor_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling StoreVendorsApi.get_vendor_template" if id.nil?
      # resource path
      local_var_path = "/vendors/templates/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def update_vendor_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling StoreVendorsApi.update_vendor" if id.nil?
      # resource path
      local_var_path = "/vendors/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def update_vendor_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling StoreVendorsApi.update_vendor_template" if id.nil?
      # resource path
      local_var_path = "/vendors/templates/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
