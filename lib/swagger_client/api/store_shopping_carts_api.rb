...
module SwaggerClient
  class StoreShoppingCartsApi
    ...
    def add_custom_discount_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling StoreShoppingCartsApi.add_custom_discount" if id.nil?
      # resource path
    ...
    def get_shipping_countries_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling StoreShoppingCartsApi.get_shipping_countries" if id.nil?
      # resource path
