...
module SwaggerClient
  class UtilMaintenanceApi
    ...
    # @option opts [Maintenance] :maintenance The maintenance object
    # @return [nil]
    def update_maintenance1(opts = {})
      update_maintenance1_with_http_info(opts)
      return nil
    end
    ...
    # @option opts [Maintenance] :maintenance The maintenance object
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def update_maintenance1_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UtilMaintenanceApi.update_maintenance1 ..."
      end
      # resource path
      local_var_path = "/maintenance".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UtilMaintenanceApi#update_maintenance1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
