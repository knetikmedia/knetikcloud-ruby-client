...
module SwaggerClient
  class UsersFriendshipsApi
    ...
    def add_friend_with_http_info(user_id, id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'user_id' when calling UsersFriendshipsApi.add_friend" if user_id.nil?
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling UsersFriendshipsApi.add_friend" if id.nil?
      # resource path
    ...
    def get_friends_with_http_info(user_id, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      fail ArgumentError, "Missing the required parameter 'user_id' when calling UsersFriendshipsApi.get_friends" if user_id.nil?
      # resource path
    ...
    def get_invite_token_with_http_info(user_id, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      fail ArgumentError, "Missing the required parameter 'user_id' when calling UsersFriendshipsApi.get_invite_token" if user_id.nil?
      # resource path
    ...
    def get_invites_with_http_info(user_id, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      fail ArgumentError, "Missing the required parameter 'user_id' when calling UsersFriendshipsApi.get_invites" if user_id.nil?
      # resource path
    ...
    def redeem_friendship_token_with_http_info(user_id, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      fail ArgumentError, "Missing the required parameter 'user_id' when calling UsersFriendshipsApi.redeem_friendship_token" if user_id.nil?
      # resource path
    ...
    def remove_or_decline_friend_with_http_info(user_id, id, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      fail ArgumentError, "Missing the required parameter 'user_id' when calling UsersFriendshipsApi.remove_or_decline_friend" if user_id.nil?
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling UsersFriendshipsApi.remove_or_decline_friend" if id.nil?
      # resource path
      local_var_path = "/users/{user_id}/friends/{id}".sub('{' + 'user_id' + '}', user_id.to_s).sub('{' + 'id' + '}', id.to_s)
