...
module SwaggerClient
  class CategoriesApi
    ...
    def delete_category_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling CategoriesApi.delete_category" if id.nil?
      # resource path
    ...
    def delete_category_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CategoriesApi.delete_category_template" if id.nil?
      # resource path
    ...
    def get_category_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CategoriesApi.get_category" if id.nil?
      # resource path
      local_var_path = "/categories/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def get_category_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CategoriesApi.get_category_template" if id.nil?
      # resource path
      local_var_path = "/categories/templates/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def update_category_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CategoriesApi.update_category" if id.nil?
      # resource path
      local_var_path = "/categories/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def update_category_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CategoriesApi.update_category_template" if id.nil?
      # resource path
      local_var_path = "/categories/templates/{id}".sub('{' + 'id' + '}', id.to_s)
