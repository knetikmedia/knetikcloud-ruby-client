...
module SwaggerClient
  class AuthRolesApi
    ...
    def delete_role_with_http_info(role, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'role' when calling AuthRolesApi.delete_role" if role.nil?
      # resource path
    ...
    def get_client_roles_with_http_info(client_key, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'client_key' when calling AuthRolesApi.get_client_roles" if client_key.nil?
      # resource path
    ...
    def get_role_with_http_info(role, opts = {})
      ...
      # verify the required parameter 'role' is set
      fail ArgumentError, "Missing the required parameter 'role' when calling AuthRolesApi.get_role" if role.nil?
      # resource path
      local_var_path = "/auth/roles/{role}".sub('{format}','json').sub('{' + 'role' + '}', role.to_s)
    ...
    def get_user_roles_with_http_info(user_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'user_id' when calling AuthRolesApi.get_user_roles" if user_id.nil?
      # resource path
    ...
    def set_client_roles(client_key, opts = {})
      set_client_roles_with_http_info(client_key, opts)
      return nil
    end
    ...
    def set_client_roles_with_http_info(client_key, opts = {})
      ...
      # verify the required parameter 'client_key' is set
      fail ArgumentError, "Missing the required parameter 'client_key' when calling AuthRolesApi.set_client_roles" if client_key.nil?
      # resource path
      local_var_path = "/auth/clients/{client_key}/roles".sub('{format}','json').sub('{' + 'client_key' + '}', client_key.to_s)
    ...
    def set_permissions_for_role(role, opts = {})
      set_permissions_for_role_with_http_info(role, opts)
      return nil
    end
    ...
    def set_permissions_for_role_with_http_info(role, opts = {})
      ...
      # verify the required parameter 'role' is set
      fail ArgumentError, "Missing the required parameter 'role' when calling AuthRolesApi.set_permissions_for_role" if role.nil?
      # resource path
    ...
    def set_user_roles(user_id, opts = {})
      set_user_roles_with_http_info(user_id, opts)
      return nil
    end
    ...
    def set_user_roles_with_http_info(user_id, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      fail ArgumentError, "Missing the required parameter 'user_id' when calling AuthRolesApi.set_user_roles" if user_id.nil?
      # resource path
      local_var_path = "/auth/users/{user_id}/roles".sub('{format}','json').sub('{' + 'user_id' + '}', user_id.to_s)
    ...
    def update_role(role, opts = {})
      update_role_with_http_info(role, opts)
      return nil
    end
    ...
    def update_role_with_http_info(role, opts = {})
      ...
      # verify the required parameter 'role' is set
      fail ArgumentError, "Missing the required parameter 'role' when calling AuthRolesApi.update_role" if role.nil?
      # resource path
      local_var_path = "/auth/roles/{role}".sub('{format}','json').sub('{' + 'role' + '}', role.to_s)
