...
module SwaggerClient
  class GamificationLeaderboardsApi
    ...
    def get_leaderboard_with_http_info(context_type, context_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'context_type' when calling GamificationLeaderboardsApi.get_leaderboard" if context_type.nil?
      # verify the required parameter 'context_id' is set
      fail ArgumentError, "Missing the required parameter 'context_id' when calling GamificationLeaderboardsApi.get_leaderboard" if context_id.nil?
      # resource path
    ...
    def get_leaderboard_rank_with_http_info(context_type, context_id, id, opts = {})
      ...
      # verify the required parameter 'context_type' is set
      fail ArgumentError, "Missing the required parameter 'context_type' when calling GamificationLeaderboardsApi.get_leaderboard_rank" if context_type.nil?
      # verify the required parameter 'context_id' is set
      fail ArgumentError, "Missing the required parameter 'context_id' when calling GamificationLeaderboardsApi.get_leaderboard_rank" if context_id.nil?
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GamificationLeaderboardsApi.get_leaderboard_rank" if id.nil?
      # resource path
