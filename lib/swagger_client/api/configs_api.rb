...
module SwaggerClient
  class ConfigsApi
    ...
    def delete_config_with_http_info(name, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'name' when calling ConfigsApi.delete_config" if name.nil?
      # resource path
    ...
    def get_config_with_http_info(name, opts = {})
      ...
      # verify the required parameter 'name' is set
      fail ArgumentError, "Missing the required parameter 'name' when calling ConfigsApi.get_config" if name.nil?
      # resource path
      local_var_path = "/configs/{name}".sub('{format}','json').sub('{' + 'name' + '}', name.to_s)
    ...
    def update_config_with_http_info(name, opts = {})
      ...
      # verify the required parameter 'name' is set
      fail ArgumentError, "Missing the required parameter 'name' when calling ConfigsApi.update_config" if name.nil?
      # resource path
      local_var_path = "/configs/{name}".sub('{format}','json').sub('{' + 'name' + '}', name.to_s)
