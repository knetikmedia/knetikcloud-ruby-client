...
module SwaggerClient
  class AuthTokensApi
    ...
    # @return [Array<(PageOauthAccessTokenResource, Fixnum, Hash)>] PageOauthAccessTokenResource data, response status code and response headers
    def get_tokens_using_get_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PageOauthAccessTokenResource')
      if @api_client.config.debugging
