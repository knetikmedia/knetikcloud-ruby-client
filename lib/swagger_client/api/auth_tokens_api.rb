...
module SwaggerClient
  class AuthTokensApi
    ...
    # @return [nil]
    def delete_token(username, client_id, opts = {})
      delete_token_with_http_info(username, client_id, opts)
      return nil
    end
    ...
    def delete_token_with_http_info(username, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AuthTokensApi.delete_token ..."
      end
      # verify the required parameter 'username' is set
      fail ArgumentError, "Missing the required parameter 'username' when calling AuthTokensApi.delete_token" if username.nil?
      # verify the required parameter 'client_id' is set
      fail ArgumentError, "Missing the required parameter 'client_id' when calling AuthTokensApi.delete_token" if client_id.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthTokensApi#delete_token\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_tokens(username, opts = {})
      delete_tokens_with_http_info(username, opts)
      return nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def delete_tokens_with_http_info(username, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AuthTokensApi.delete_tokens ..."
      end
      # verify the required parameter 'username' is set
      fail ArgumentError, "Missing the required parameter 'username' when calling AuthTokensApi.delete_tokens" if username.nil?
      # resource path
      local_var_path = "/auth/tokens/{username}".sub('{' + 'username' + '}', username.to_s)
    ...
    def get_token_with_http_info(username, client_id, opts = {})
      ...
      # verify the required parameter 'username' is set
      fail ArgumentError, "Missing the required parameter 'username' when calling AuthTokensApi.get_token" if username.nil?
      # verify the required parameter 'client_id' is set
      fail ArgumentError, "Missing the required parameter 'client_id' when calling AuthTokensApi.get_token" if client_id.nil?
      # resource path
      local_var_path = "/auth/tokens/{username}/{client_id}".sub('{' + 'username' + '}', username.to_s).sub('{' + 'client_id' + '}', client_id.to_s)
