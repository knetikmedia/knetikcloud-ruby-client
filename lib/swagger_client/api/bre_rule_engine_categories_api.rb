...
module SwaggerClient
  class BRERuleEngineCategoriesApi
    ...
    def delete_bre_category_template_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling BRERuleEngineCategoriesApi.delete_bre_category_template" if id.nil?
      # resource path
    ...
    def get_bre_category_with_http_info(name, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'name' when calling BRERuleEngineCategoriesApi.get_bre_category" if name.nil?
      # resource path
    ...
    def get_bre_category_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling BRERuleEngineCategoriesApi.get_bre_category_template" if id.nil?
      # resource path
      local_var_path = "/bre/categories/templates/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def update_bre_category(name, opts = {})
      update_bre_category_with_http_info(name, opts)
      return nil
    end
    ...
    def update_bre_category_with_http_info(name, opts = {})
      ...
      # verify the required parameter 'name' is set
      fail ArgumentError, "Missing the required parameter 'name' when calling BRERuleEngineCategoriesApi.update_bre_category" if name.nil?
      # resource path
      local_var_path = "/bre/categories/{name}".sub('{format}','json').sub('{' + 'name' + '}', name.to_s)
    ...
    def update_bre_category_template(id, opts = {})
      update_bre_category_template_with_http_info(id, opts)
      return nil
    end
    ...
    def update_bre_category_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling BRERuleEngineCategoriesApi.update_bre_category_template" if id.nil?
      # resource path
      local_var_path = "/bre/categories/templates/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
