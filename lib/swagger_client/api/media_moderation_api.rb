...
module SwaggerClient
  class MediaModerationApi
    ...
    def get_moderation_report(id, opts = {})
      get_moderation_report_with_http_info(id, opts)
      return nil
    end
    ...
    def get_moderation_report_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling MediaModerationApi.get_moderation_report" if id.nil?
      # resource path
    ...
    def update_moderation_report_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling MediaModerationApi.update_moderation_report" if id.nil?
      # resource path
      local_var_path = "/moderation/reports/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
