...
module SwaggerClient
  class StoreSubscriptionsApi
    ...
    def list_billing_reports_using_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: StoreSubscriptionsApi.list_billing_reports_using_get ..."
      end
      # resource path
      local_var_path = "/subscriptions/reports".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StoreSubscriptionsApi#list_billing_reports_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
