...
module SwaggerClient
  ...
  class UserAchievementResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'achieved')
        self.achieved = attributes[:'achieved']
      end

      if attributes.has_key?(:'achievement_name')
      ...
      if attributes.has_key?(:'earned_date')
        self.earned_date = attributes[:'earned_date']
      end
    ...
    def hash
      [achieved, achievement_name, created_date, earned_date, id, progress, updated_date, user_id].hash
    end
