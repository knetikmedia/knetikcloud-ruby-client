...
module SwaggerClient
  ...
  class AchievementDefinitionResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_value')
        self.max_value = attributes[:'max_value']
      end

      if attributes.has_key?(:'min_value')
    ...
    def hash
      [additional_properties, created_date, description, hidden, max_value, min_value, name, rule_id, tags, template, trigger_event_name, updated_date].hash
    end
