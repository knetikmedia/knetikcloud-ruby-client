...
module SwaggerClient
  ...
  class ClientResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'access_token_validity_seconds')
      ...
      if attributes.has_key?(:'grant_types')
      ...
      if attributes.has_key?(:'refresh_token_validity_seconds')
    ...
    def hash
      [access_token_validity_seconds, client_key, grant_types, id, is_public, locked, name, redirect_uris, refresh_token_validity_seconds, secret].hash
    end
