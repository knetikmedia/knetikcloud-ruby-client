...
module SwaggerClient
  ...
  class DeltaResource
    ...
    def valid?
      state_validator = EnumAttributeValidator.new('String', ["UPDATED", "REMOVED"])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["UPDATED", "REMOVED"])
    ...
    def hash
      [category_id, media_type, question_id, state, tags, updated_date].hash
    end
