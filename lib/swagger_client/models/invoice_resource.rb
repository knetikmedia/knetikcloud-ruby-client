...
module SwaggerClient
  ...
  class InvoiceResource
    ...
    def hash
      [billing_address1, billing_address2, billing_city_name, billing_country_name, billing_full_name, billing_postal_code, billing_state_name, cart_id, created_date, currency, current_fulfillment_status, current_payment_status, discount, email, fed_tax, grand_total, id, invoice_number, items, name_prefix, order_notes, parent_invoice_id, payment_method_id, phone, phone_number, shipping, shipping_address1, shipping_address2, shipping_city_name, shipping_country_name, shipping_full_name, shipping_postal_code, shipping_state_name, sort, state_tax, subtotal, updated_date, user, vendor_id, vendor_name].hash
    end
