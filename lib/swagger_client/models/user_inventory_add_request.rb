...
module SwaggerClient
  ...
  class UserInventoryAddRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'skip_invoice')
        self.skip_invoice = attributes[:'skip_invoice']
      end
    ...
    def list_invalid_properties
      ...
      if @skip_invoice.nil?
        invalid_properties.push("invalid value for 'skip_invoice', skip_invoice cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @skip_invoice.nil?
    ...
    def hash
      [note, overrides, skip_invoice, sku].hash
    end
