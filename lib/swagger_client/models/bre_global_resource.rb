...
module SwaggerClient
  ...
  class BreGlobalResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'system_global')
        self.system_global = attributes[:'system_global']
      end
    ...
    def hash
      [description, id, key, name, scopes, system_global, type].hash
    end
