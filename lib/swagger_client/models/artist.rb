...
module SwaggerClient
  ...
  class Artist
    ...
    def hash
      [additional_properties, born, contribution_count, created, died, id, long_description, name, priority, properties_string, short_description, template, updated].hash
    end
