...
module SwaggerClient
  ...
  class FlagReportResource
    ...
    def valid?
      ...
      resolution_validator = EnumAttributeValidator.new('String', ["banned", "ignored"])
    ...
    def resolution=(resolution)
      validator = EnumAttributeValidator.new('String', ["banned", "ignored"])
    ...
    def hash
      [context, context_id, created_date, id, reason, resolution, resolved, updated_date].hash
    end
