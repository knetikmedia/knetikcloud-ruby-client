...
module SwaggerClient
  ...
  class ShippingItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_tier_total')
        self.max_tier_total = attributes[:'max_tier_total']
      end
    ...
    def list_invalid_properties
      ...
      if @max_tier_total.nil?
        invalid_properties.push("invalid value for 'max_tier_total', max_tier_total cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @max_tier_total.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          max_tier_total == o.max_tier_total &&
          name == o.name &&
    ...
    def hash
      [additional_properties, behaviors, category, countries, created_date, displayable, geo_country_list, geo_policy_type, id, long_description, max_tier_total, name, shipping_tier, short_description, skus, sort, store_end, store_start, tags, taxable, template, type_hint, unique_key, updated_date, vendor_id].hash
    end
