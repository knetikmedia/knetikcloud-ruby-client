...
module SwaggerClient
  ...
  class CartShippingOption
    ...
    attr_accessor :shipping_item_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'shipping_item_id')
        self.shipping_item_id = attributes[:'shipping_item_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          price == o.price &&
          shipping_item_id == o.shipping_item_id &&
          sku == o.sku &&
          taxable == o.taxable &&
    ...
    def hash
      [currency_code, description, name, original_price, price, shipping_item_id, sku, taxable, vendor_id, vendor_name].hash
    end
