...
module SwaggerClient
  ...
  class CouponItem
    ...
    def hash
      [additional_properties, behaviors, category, coupon_type_hint, created_date, discount_max, discount_min_cart_value, discount_type, discount_value, displayable, exclusive, geo_country_list, geo_policy_type, id, item_id, long_description, max_quantity, name, shipping_tier, short_description, skus, sort, store_end, store_start, tags, template, type_hint, unique_key, updated_date, valid_for_tags, vendor_id].hash
    end
