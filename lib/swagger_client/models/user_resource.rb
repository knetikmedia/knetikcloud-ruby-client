...
module SwaggerClient
  ...
  class UserResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'member_since')
        self.member_since = attributes[:'member_since']
      end
    ...
    def hash
      [additional_properties, address, address2, avatar_url, children, city, country_code, currency_code, date_of_birth, description, display_name, email, first_name, fullname, gender, id, language_code, last_name, last_updated, member_since, mobile_number, parents, password, postal_code, state, tags, template, timezone_code, username].hash
    end
