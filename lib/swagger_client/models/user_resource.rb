...
module SwaggerClient
  ...
  class UserResource
    ...
    def hash
      [additional_properties, address, address2, avatar_url, city, country_code, currency_code, date_of_birth, description, display_name, email, first_name, fullname, gender, id, language_code, last_name, mobile_number, password, postal_code, state, template, timezone_code, username].hash
    end
