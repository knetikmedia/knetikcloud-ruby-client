  ...
  class BRERuleEngineGlobalsApi
    ...
    def delete_bre_global_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling BRERuleEngineGlobalsApi.delete_bre_global"
      end
      # resource path
    ...
    def get_bre_global_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling BRERuleEngineGlobalsApi.get_bre_global"
      end
      # resource path
      local_var_path = "/bre/globals/definitions/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def update_bre_global_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling BRERuleEngineGlobalsApi.update_bre_global"
      end
      # resource path
      local_var_path = "/bre/globals/definitions/{id}".sub('{' + 'id' + '}', id.to_s)
