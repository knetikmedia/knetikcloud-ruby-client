  ...
  class CampaignsRewardsApi
    ...
    def delete_reward_set_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CampaignsRewardsApi.delete_reward_set"
      end
      # resource path
    ...
    def get_reward_set_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CampaignsRewardsApi.get_reward_set"
      end
      # resource path
      local_var_path = "/rewards/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def update_reward_set_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CampaignsRewardsApi.update_reward_set"
      end
      # resource path
      local_var_path = "/rewards/{id}".sub('{' + 'id' + '}', id.to_s)
