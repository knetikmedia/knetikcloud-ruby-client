  ...
  class RuleEngineEventsApi
    ...
    def send_bre_event_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RuleEngineEventsApi.send_bre_event ..."
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'String')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RuleEngineEventsApi#send_bre_event\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
