  ...
  class StoreBundlesApi
    ...
    def delete_bundle_item_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling StoreBundlesApi.delete_bundle_item"
      end
      # resource path
      local_var_path = "/store/bundles/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def delete_bundle_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling StoreBundlesApi.delete_bundle_template"
      end
      # resource path
      local_var_path = "/store/bundles/templates/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def get_bundle_item_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling StoreBundlesApi.get_bundle_item"
      end
      # resource path
      local_var_path = "/store/bundles/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def get_bundle_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling StoreBundlesApi.get_bundle_template"
      end
      # resource path
      local_var_path = "/store/bundles/templates/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def update_bundle_item_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling StoreBundlesApi.update_bundle_item"
      end
      # resource path
      local_var_path = "/store/bundles/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def update_bundle_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling StoreBundlesApi.update_bundle_template"
      end
      # resource path
      local_var_path = "/store/bundles/templates/{id}".sub('{' + 'id' + '}', id.to_s)
