...
module KnetikCloudClient
  class AccessTokenApi
    ...
    def get_o_auth_token_with_http_info(grant_type, client_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'grant_type' when calling AccessTokenApi.get_o_auth_token" if grant_type.nil?
      # verify enum value
      unless ['client_credentials', 'password'].include?(grant_type)
        fail ArgumentError, "invalid value for 'grant_type', must be one of client_credentials, password"
      end
      # verify the required parameter 'client_id' is set
      fail ArgumentError, "Missing the required parameter 'client_id' when calling AccessTokenApi.get_o_auth_token" if client_id.nil?
      # resource path
