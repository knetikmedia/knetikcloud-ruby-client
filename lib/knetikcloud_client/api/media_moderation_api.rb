...
module KnetikCloudClient
  class MediaModerationApi
    ...
    def add_flag_with_http_info(opts = {})
    ...
    def delete_flag(opts = {})
      delete_flag_with_http_info(opts)
      return nil
    end
    ...
    def delete_flag_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MediaModerationApi.delete_flag ..."
      end
      # resource path
      local_var_path = "/moderation/flags"
      ...
      # query parameters
      query_params = {}
      query_params[:'context_name'] = opts[:'context_name'] if !opts[:'context_name'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MediaModerationApi#delete_flag\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [Array<(PageResourceFlagResource, Fixnum, Hash)>] PageResourceFlagResource data, response status code and response headers
    def get_flags_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MediaModerationApi.get_flags ..."
      end
      # resource path
      local_var_path = "/moderation/flags"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'PageResourceFlagResource')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MediaModerationApi#get_flags\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
