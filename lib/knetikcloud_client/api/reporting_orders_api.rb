  ...
  class ReportingOrdersApi
    ...
    def get_invoice_reports_with_http_info(currency_code, opts = {})
      ...
      if @api_client.config.client_side_validation && currency_code.nil?
        fail ArgumentError, "Missing the required parameter 'currency_code' when calling ReportingOrdersApi.get_invoice_reports"
      end
      ...
      # resource path
      local_var_path = "/reporting/orders/count/{currency_code}".sub('{' + 'currency_code' + '}', currency_code.to_s)
