...
module KnetikCloudClient
  class LogsApi
    ...
    # @option opts [String] :filter_event_id Filter event logs by request id
    ...
    # @option opts [Integer] :size The number of objects returned per page (default to 25)
    # @option opts [Integer] :page The number of the page returned, starting with 1 (default to 1)
    # @option opts [String] :order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (default to timestamp:DESC)
