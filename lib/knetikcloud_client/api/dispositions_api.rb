...
module KnetikCloudClient
  class DispositionsApi
    ...
    def delete_disposition_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling DispositionsApi.delete_disposition" if id.nil?
      # resource path
    ...
    def get_disposition_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling DispositionsApi.get_disposition" if id.nil?
      # resource path
      local_var_path = "/dispositions/{id}".sub('{' + 'id' + '}', id.to_s)
