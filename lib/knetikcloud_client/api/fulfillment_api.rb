...
module KnetikCloudClient
  class FulfillmentApi
    ...
    def delete_fulfillment_type_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling FulfillmentApi.delete_fulfillment_type" if id.nil?
      # resource path
    ...
    def get_fulfillment_type_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling FulfillmentApi.get_fulfillment_type" if id.nil?
      # resource path
      local_var_path = "/store/fulfillment/types/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def update_fulfillment_type_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling FulfillmentApi.update_fulfillment_type" if id.nil?
      # resource path
      local_var_path = "/store/fulfillment/types/{id}".sub('{' + 'id' + '}', id.to_s)
