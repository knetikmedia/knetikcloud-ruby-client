...
module KnetikCloudClient
  class BRERuleEngineRulesApi
    ...
    def delete_bre_rule_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling BRERuleEngineRulesApi.delete_bre_rule" if id.nil?
      # resource path
    ...
    def get_bre_rule_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling BRERuleEngineRulesApi.get_bre_rule" if id.nil?
      # resource path
      local_var_path = "/bre/rules/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def set_bre_rule_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling BRERuleEngineRulesApi.set_bre_rule" if id.nil?
      # resource path
    ...
    def update_bre_rule_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling BRERuleEngineRulesApi.update_bre_rule" if id.nil?
      # resource path
      local_var_path = "/bre/rules/{id}".sub('{' + 'id' + '}', id.to_s)
