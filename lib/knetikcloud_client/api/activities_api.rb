...
module KnetikCloudClient
  class ActivitiesApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc] :activity_resource The activity resource object
    # @return [Array<(RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc, Fixnum, Hash)>] RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc data, response status code and response headers
    def create_activity_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc')
      if @api_client.config.debugging
    ...
    # @option opts [AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings] :activity_occurrence_resource The activity occurrence object
    # @return [Array<(AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings, Fixnum, Hash)>] AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings data, response status code and response headers
    def create_activity_occurrence_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings')
      if @api_client.config.debugging
    ...
    def delete_activity_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling ActivitiesApi.delete_activity" if id.nil?
      # resource path
    ...
    def delete_activity_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ActivitiesApi.delete_activity_template" if id.nil?
      # resource path
    ...
    def get_activity_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ActivitiesApi.get_activity" if id.nil?
      # resource path
      local_var_path = "/activities/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def get_activity_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ActivitiesApi.get_activity_template" if id.nil?
      # resource path
      local_var_path = "/activities/templates/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def set_activity_occurrence_results_with_http_info(activity_occurrence_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'activity_occurrence_id' when calling ActivitiesApi.set_activity_occurrence_results" if activity_occurrence_id.nil?
      # resource path
    ...
    def update_activity_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ActivitiesApi.update_activity" if id.nil?
      # resource path
      local_var_path = "/activities/{id}".sub('{' + 'id' + '}', id.to_s)
    ...
    def update_activity_occurrence_with_http_info(activity_occurrence_id, opts = {})
      ...
      # verify the required parameter 'activity_occurrence_id' is set
      fail ArgumentError, "Missing the required parameter 'activity_occurrence_id' when calling ActivitiesApi.update_activity_occurrence" if activity_occurrence_id.nil?
      # resource path
    ...
    def update_activity_template_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ActivitiesApi.update_activity_template" if id.nil?
      # resource path
      local_var_path = "/activities/templates/{id}".sub('{' + 'id' + '}', id.to_s)
