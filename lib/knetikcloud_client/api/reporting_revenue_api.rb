  ...
  class ReportingRevenueApi
    ...
    def get_item_revenue_with_http_info(currency_code, opts = {})
      ...
      if @api_client.config.client_side_validation && currency_code.nil?
        fail ArgumentError, "Missing the required parameter 'currency_code' when calling ReportingRevenueApi.get_item_revenue"
      end
      # resource path
      local_var_path = "/reporting/revenue/item-sales/{currency_code}".sub('{' + 'currency_code' + '}', currency_code.to_s)
    ...
    def get_refund_revenue_with_http_info(currency_code, opts = {})
      ...
      # verify the required parameter 'currency_code' is set
      if @api_client.config.client_side_validation && currency_code.nil?
        fail ArgumentError, "Missing the required parameter 'currency_code' when calling ReportingRevenueApi.get_refund_revenue"
      end
      # resource path
      local_var_path = "/reporting/revenue/refunds/{currency_code}".sub('{' + 'currency_code' + '}', currency_code.to_s)
    ...
    def get_revenue_by_country_with_http_info(currency_code, opts = {})
      ...
      # verify the required parameter 'currency_code' is set
      if @api_client.config.client_side_validation && currency_code.nil?
        fail ArgumentError, "Missing the required parameter 'currency_code' when calling ReportingRevenueApi.get_revenue_by_country"
      end
      # resource path
      local_var_path = "/reporting/revenue/countries/{currency_code}".sub('{' + 'currency_code' + '}', currency_code.to_s)
    ...
    def get_revenue_by_item_with_http_info(currency_code, opts = {})
      ...
      # verify the required parameter 'currency_code' is set
      if @api_client.config.client_side_validation && currency_code.nil?
        fail ArgumentError, "Missing the required parameter 'currency_code' when calling ReportingRevenueApi.get_revenue_by_item"
      end
      # resource path
      local_var_path = "/reporting/revenue/products/{currency_code}".sub('{' + 'currency_code' + '}', currency_code.to_s)
    ...
    def get_subscription_revenue_with_http_info(currency_code, opts = {})
      ...
      # verify the required parameter 'currency_code' is set
      if @api_client.config.client_side_validation && currency_code.nil?
        fail ArgumentError, "Missing the required parameter 'currency_code' when calling ReportingRevenueApi.get_subscription_revenue"
      end
      # resource path
      local_var_path = "/reporting/revenue/subscription-sales/{currency_code}".sub('{' + 'currency_code' + '}', currency_code.to_s)
