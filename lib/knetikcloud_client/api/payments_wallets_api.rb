  ...
  class PaymentsWalletsApi
    ...
    def get_user_wallet_with_http_info(user_id, currency_code, opts = {})
      ...
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling PaymentsWalletsApi.get_user_wallet"
      end
      # verify the required parameter 'currency_code' is set
      if @api_client.config.client_side_validation && currency_code.nil?
        fail ArgumentError, "Missing the required parameter 'currency_code' when calling PaymentsWalletsApi.get_user_wallet"
      end
      # resource path
    ...
    def get_user_wallet_transactions_with_http_info(user_id, currency_code, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling PaymentsWalletsApi.get_user_wallet_transactions"
      end
      # verify the required parameter 'currency_code' is set
      if @api_client.config.client_side_validation && currency_code.nil?
        fail ArgumentError, "Missing the required parameter 'currency_code' when calling PaymentsWalletsApi.get_user_wallet_transactions"
      end
      # resource path
    ...
    def get_user_wallets_with_http_info(user_id, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling PaymentsWalletsApi.get_user_wallets"
      end
      # resource path
    ...
    def get_wallet_transactions_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'filter_sign'] && !['positive', 'negative'].include?(opts[:'filter_sign'])
    ...
    def update_wallet_balance_with_http_info(user_id, currency_code, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling PaymentsWalletsApi.update_wallet_balance"
      end
      # verify the required parameter 'currency_code' is set
      if @api_client.config.client_side_validation && currency_code.nil?
        fail ArgumentError, "Missing the required parameter 'currency_code' when calling PaymentsWalletsApi.update_wallet_balance"
      end
      # resource path
