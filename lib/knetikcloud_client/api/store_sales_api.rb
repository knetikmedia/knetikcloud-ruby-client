  ...
  class StoreSalesApi
    ...
    def delete_catalog_sale_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling StoreSalesApi.delete_catalog_sale"
      end
      # resource path
    ...
    def update_catalog_sale_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling StoreSalesApi.update_catalog_sale"
      end
      # resource path
      local_var_path = "/store/sales/{id}".sub('{' + 'id' + '}', id.to_s)
