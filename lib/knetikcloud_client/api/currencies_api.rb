...
module KnetikCloudClient
  class CurrenciesApi
    ...
    def create_currency(opts = {})
      data, _status_code, _headers = create_currency_with_http_info(opts)
      return data
    end
    ...
    def create_currency_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CurrenciesApi.create_currency ..."
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CurrenciesApi#create_currency\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_currency_with_http_info(code, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'code' when calling CurrenciesApi.delete_currency" if code.nil?
      # resource path
      local_var_path = "/currencies/{code}".sub('{' + 'code' + '}', code.to_s)
    ...
    def get_currency_with_http_info(code, opts = {})
      ...
      # verify the required parameter 'code' is set
      fail ArgumentError, "Missing the required parameter 'code' when calling CurrenciesApi.get_currency" if code.nil?
      # resource path
      local_var_path = "/currencies/{code}".sub('{' + 'code' + '}', code.to_s)
    ...
    # @option opts [CurrencyResource] :currency The currency object
    # @return [nil]
    def update_currency(code, opts = {})
      update_currency_with_http_info(code, opts)
      return nil
    end
    ...
    # @option opts [CurrencyResource] :currency The currency object
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def update_currency_with_http_info(code, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CurrenciesApi.update_currency ..."
      end
      # verify the required parameter 'code' is set
      fail ArgumentError, "Missing the required parameter 'code' when calling CurrenciesApi.update_currency" if code.nil?
      # resource path
      local_var_path = "/currencies/{code}".sub('{' + 'code' + '}', code.to_s)
