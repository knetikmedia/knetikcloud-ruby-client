...
module KnetikCloudClient
  ...
  class Topic
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'topic_map')
        self.topic_map = attributes[:'topic_map']
      end
    ...
    def hash
      [created_date, display_name, id, locked, tags, topic_map, updated_date, user_count].hash
    end
