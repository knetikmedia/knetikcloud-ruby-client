...
module KnetikCloudClient
  ...
  class ListPropertyDefinitionResource
    ...
    attr_accessor :value_definition
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'value_definition')
        self.value_definition = attributes[:'value_definition']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          value_definition == o.value_definition
    end
    ...
    def hash
      [description, field_list, friendly_name, name, option_label_path, option_value_path, options_url, required, type, max_count, min_count, value_definition].hash
    end
