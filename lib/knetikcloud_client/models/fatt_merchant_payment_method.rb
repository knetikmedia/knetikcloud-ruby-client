...
module KnetikCloudClient
  ...
  class FattMerchantPaymentMethod
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'address_zip')
        self.address_zip = attributes[:'address_zip']
      end

      if attributes.has_key?(:'card_last_four')
    ...
    def list_invalid_properties
      ...
      if @card_last_four.nil?
        invalid_properties.push("invalid value for 'card_last_four', card_last_four cannot be nil.")
      end
    ...
    def valid?
      return false if @card_last_four.nil?
    ...
    def hash
      [address1, address2, address_city, address_country, address_state, address_zip, card_last_four, created_at, customer_id, deleted_at, id, nickname, updated_at].hash
    end
