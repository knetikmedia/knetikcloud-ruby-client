...
module KnetikCloudClient
  ...
  class BundleItem
    ...
    def hash
      [additional_properties, behaviors, bundled_skus, category, created_date, displayable, geo_country_list, geo_policy_type, id, long_description, name, shipping_tier, short_description, skus, sort, store_end, store_start, tags, template, type_hint, unique_key, updated_date, vendor_id].hash
    end
