...
module KnetikCloudClient
  ...
  class TopicSubscriber
    ...
    attr_accessor :topic_subscriber_map
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'topic_id')
        self.topic_id = attributes[:'topic_id']
      end

      if attributes.has_key?(:'topic_subscriber_map')
        self.topic_subscriber_map = attributes[:'topic_subscriber_map']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          topic_id == o.topic_id &&
          topic_subscriber_map == o.topic_subscriber_map &&
          user_id == o.user_id &&
          username == o.username
    end
    ...
    def hash
      [disabled, email, join_date, mobile_number, topic_id, topic_subscriber_map, user_id, username].hash
    end
