...
module KnetikCloudClient
  ...
  class ActivityResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'launch')
        self.launch = attributes[:'launch']
      end
    ...
    def hash
      [additional_properties, created_date, entitlements, id, launch, long_description, name, reward_set, settings, short_description, template, template_id, type, unique_key, updated_date].hash
    end
