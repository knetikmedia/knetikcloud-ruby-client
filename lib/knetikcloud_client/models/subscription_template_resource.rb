...
module KnetikCloudClient
  ...
  class SubscriptionTemplateResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'plan_template')
        self.plan_template = attributes[:'plan_template']
      end
    ...
    def hash
      [allow_additional, created_date, id, name, plan_template, properties, updated_date].hash
    end
