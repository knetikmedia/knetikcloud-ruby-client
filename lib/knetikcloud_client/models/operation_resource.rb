...
module KnetikCloudClient
  ...
  class OperationResource
    ...
    def self.swagger_types
      {
        ...
        :'op' => :'String',
        :'return_type' => :'String',
        :'supported_operators' => :'Array<OperationDefinitionResource>',
        :'type' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'return_type')
        self.return_type = attributes[:'return_type']
      end

      if attributes.has_key?(:'supported_operators')
        if (value = attributes[:'supported_operators']).is_a?(Array)
    ...
    def hash
      [args, definition, op, return_type, supported_operators, type].hash
    end
