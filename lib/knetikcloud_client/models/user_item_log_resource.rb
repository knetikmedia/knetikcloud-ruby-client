...
module KnetikCloudClient
  ...
  class UserItemLogResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'log_date')
      ...
      if attributes.has_key?(:'user_inventory')
        self.user_inventory = attributes[:'user_inventory']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          user == o.user &&
          user_inventory == o.user_inventory
    end
    ...
    def hash
      [id, info, item, log_date, type, user, user_inventory].hash
    end
