...
module KnetikCloudClient
  ...
  class GooglePaymentRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'json_payload')
        self.json_payload = attributes[:'json_payload']
      end
    ...
    def list_invalid_properties
      ...
      if @json_payload.nil?
        invalid_properties.push("invalid value for 'json_payload', json_payload cannot be nil.")
      end
    ...
    def valid?
      return false if @json_payload.nil?
