...
module KnetikCloudClient
  ...
  class DeviceResource
    ...
    def valid?
      condition_validator = EnumAttributeValidator.new('String', ["New", "Defective", "Reconditioned"])
      return false unless condition_validator.valid?(@condition)
      return false if @id.nil?
      status_validator = EnumAttributeValidator.new('String', ["Active", "PendingActive", "Inactive", "Repair"])
    ...
    def condition=(condition)
      validator = EnumAttributeValidator.new('String', ["New", "Defective", "Reconditioned"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Active", "PendingActive", "Inactive", "Repair"])
    ...
    def hash
      [authorization, condition, created_date, data, description, device_type, id, location, mac_address, make, model, name, os, serial, status, updated_date, user, users].hash
    end
