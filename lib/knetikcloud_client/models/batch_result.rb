...
module KnetikCloudClient
  ...
  class BatchResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'batch_return')
        if (value = attributes[:'batch_return']).is_a?(Array)
          self.batch_return = value
        end
      end
    ...
    def hash
      [batch_return, created_date, id, updated_date].hash
    end
