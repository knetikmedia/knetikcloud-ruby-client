...
module KnetikCloudClient
  ...
  class Subscription
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'subscription_plans')
        if (value = attributes[:'subscription_plans']).is_a?(Array)
          self.subscription_plans = value
        end
      end
    ...
    def hash
      [additional_properties, behaviors, category, created_date, id, long_description, name, short_description, sort, tags, template, type_hint, unique_key, updated_date, displayable, geo_country_list, geo_policy_type, shipping_tier, skus, store_end, store_start, vendor_id, availability, consolidation_day_of_month, subscription_plans].hash
    end
