...
module KnetikCloudClient
  ...
  class WebsocketSubscribeEvent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'user_resource')
        self.user_resource = attributes[:'user_resource']
      end
    ...
    def hash
      [client, customer, do_not_broadcast, section, source, specifics, synchronous, timestamp, type, topic, user_resource].hash
    end
