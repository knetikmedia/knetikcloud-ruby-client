...
module KnetikCloudClient
  ...
  class ActivityUserResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'joined_date')
        self.joined_date = attributes[:'joined_date']
      end

      if attributes.has_key?(:'left_date')
        self.left_date = attributes[:'left_date']
      end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["present", "ready", "left", "surrendered", "disconnected"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["present", "ready", "left", "surrendered", "disconnected"])
    ...
    def hash
      [host, id, joined_date, left_date, metric, status, user].hash
    end
