...
module KnetikCloudClient
  ...
  class RewardCurrencyResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'currency_name')
        self.currency_name = attributes[:'currency_name']
      end

      if attributes.has_key?(:'max_rank')
        self.max_rank = attributes[:'max_rank']
      end

      if attributes.has_key?(:'min_rank')
        self.min_rank = attributes[:'min_rank']
      end
    ...
    def list_invalid_properties
      ...
      if @max_rank.nil?
        invalid_properties.push("invalid value for 'max_rank', max_rank cannot be nil.")
      end

      if @min_rank.nil?
        invalid_properties.push("invalid value for 'min_rank', min_rank cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @max_rank.nil?
      return false if @min_rank.nil?
    ...
    def hash
      [currency_code, currency_name, max_rank, min_rank, percent, value].hash
    end
