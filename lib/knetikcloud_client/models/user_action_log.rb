...
module KnetikCloudClient
  ...
  class UserActionLog
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'action_description')
    ...
    def list_invalid_properties
      ...
      if @action_description.nil?
        invalid_properties.push("invalid value for 'action_description', action_description cannot be nil.")
      end
    ...
    def valid?
      return false if @action_description.nil?
    ...
    def hash
      [action_description, action_name, created_date, details, id, request_id, user_id].hash
    end
