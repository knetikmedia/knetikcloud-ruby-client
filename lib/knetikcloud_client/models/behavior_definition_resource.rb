...
module KnetikCloudClient
  ...
  class BehaviorDefinitionResource
    ...
    attr_accessor :prerequisite_behaviors
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'prerequisite_behaviors')
        if (value = attributes[:'prerequisite_behaviors']).is_a?(Array)
          self.prerequisite_behaviors = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          prerequisite_behaviors == o.prerequisite_behaviors &&
    ...
    def hash
      [description, prerequisite_behaviors, properties, type_hint].hash
    end
