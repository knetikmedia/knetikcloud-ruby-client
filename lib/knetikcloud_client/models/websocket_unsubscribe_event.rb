...
module KnetikCloudClient
  ...
  class WebsocketUnsubscribeEvent
    ...
    attr_accessor :topic_subscriber
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'topic_subscriber')
        self.topic_subscriber = attributes[:'topic_subscriber']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          topic == o.topic &&
          topic_subscriber == o.topic_subscriber
    end
    ...
    def hash
      [client, customer, do_not_broadcast, section, source, specifics, synchronous, timestamp, type, topic, topic_subscriber].hash
    end
