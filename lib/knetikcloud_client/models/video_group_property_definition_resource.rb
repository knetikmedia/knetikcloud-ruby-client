...
module KnetikCloudClient
  ...
  class VideoGroupPropertyDefinitionResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_file_size')
        self.max_file_size = attributes[:'max_file_size']
      end

      if attributes.has_key?(:'min_count')
    ...
    def hash
      [description, field_list, friendly_name, name, option_label_path, option_value_path, options_url, required, type, file_type, max_count, max_file_size, min_count, max_height, max_length, max_width, min_height, min_length, min_width].hash
    end
