...
module KnetikCloudClient
  ...
  class StoreItemTemplateResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sku_template')
        self.sku_template = attributes[:'sku_template']
      end
    ...
    def hash
      [allow_additional, behaviors, created_date, id, name, properties, sku_template, updated_date].hash
    end
