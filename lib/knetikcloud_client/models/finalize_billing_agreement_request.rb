...
module KnetikCloudClient
  ...
  class FinalizeBillingAgreementRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'new_default')
        self.new_default = attributes[:'new_default']
      end

      if attributes.has_key?(:'payer_id')
    ...
    def hash
      [invoice_id, new_default, payer_id, token, user_id].hash
    end
