...
module KnetikCloudClient
  ...
  class VideoPropertyDefinitionResource
    ...
    def hash
      [description, field_list, friendly_name, name, option_label_path, option_value_path, options_url, required, type, file_type, max_height, max_length, max_width, min_height, min_length, min_width].hash
    end
