...
module KnetikCloudClient
  ...
  class FileGroupPropertyDefinitionResource
    ...
    def hash
      [description, field_list, friendly_name, name, option_label_path, option_value_path, options_url, required, type, file_type, max_count, max_file_size, min_count].hash
    end
