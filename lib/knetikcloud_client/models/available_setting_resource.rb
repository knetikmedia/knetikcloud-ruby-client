...
module KnetikCloudClient
  ...
  class AvailableSettingResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'advanced_option')
        self.advanced_option = attributes[:'advanced_option']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          advanced_option == o.advanced_option &&
    ...
    def hash
      [advanced_option, default_value, description, key, name, options, type].hash
    end
