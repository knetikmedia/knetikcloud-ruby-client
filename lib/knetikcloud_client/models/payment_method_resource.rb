...
module KnetikCloudClient
  ...
  class PaymentMethodResource
    ...
    def hash
      [created_date, default, disabled, expiration_date, expiration_month, expiration_year, id, last4, name, payment_method_type, payment_type, sort, token, unique_key, updated_date, user_id, verified].hash
    end
