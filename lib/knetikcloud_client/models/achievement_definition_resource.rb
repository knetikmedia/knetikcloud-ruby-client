...
module KnetikCloudClient
  ...
  class AchievementDefinitionResource
    ...
    attr_accessor :required_progress
    ...
    attr_accessor :trigger_event_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'required_progress')
        self.required_progress = attributes[:'required_progress']
      end
      ...
      if attributes.has_key?(:'trigger_event_name')
        self.trigger_event_name = attributes[:'trigger_event_name']
      end
    ...
    def list_invalid_properties
      ...
      if @required_progress.nil?
        invalid_properties.push("invalid value for 'required_progress', required_progress cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @required_progress.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          hidden == o.hidden &&
          name == o.name &&
          required_progress == o.required_progress &&
          rule_id == o.rule_id &&
          tags == o.tags &&
          template == o.template &&
          trigger_event_name == o.trigger_event_name &&
    ...
    def hash
      [additional_properties, created_date, description, hidden, name, required_progress, rule_id, tags, template, trigger_event_name, updated_date].hash
    end
