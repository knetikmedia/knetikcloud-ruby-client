...
module KnetikCloudClient
  ...
  class SubscriptionStatusWrapper
    ...
    def valid?
      value_validator = EnumAttributeValidator.new('String', ["current", "canceled", "stopped", "payment_failed", "suspended"])
    ...
    def value=(value)
      validator = EnumAttributeValidator.new('String', ["current", "canceled", "stopped", "payment_failed", "suspended"])
