...
module KnetikCloudClient
  ...
  class UsernameLookupResource
    ...
    attr_accessor :required_key_type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lookup_key')
        self.lookup_key = attributes[:'lookup_key']
      end

      if attributes.has_key?(:'required_key_type')
        self.required_key_type = attributes[:'required_key_type']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          required_key_type == o.required_key_type &&
          type == o.type &&
    ...
    def hash
      [definition, lookup_key, required_key_type, type, value_type].hash
    end
