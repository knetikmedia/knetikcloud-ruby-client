...
module KnetikCloudClient
  ...
  class LimitedGettableGroup
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'active_only')
        self.active_only = attributes[:'active_only']
      end
      ...
      if attributes.has_key?(:'owned_limit')
        self.owned_limit = attributes[:'owned_limit']
      end
    ...
    def list_invalid_properties
      ...
      if @active_only.nil?
        invalid_properties.push("invalid value for 'active_only', active_only cannot be nil.")
      end

      if @owned_limit.nil?
        invalid_properties.push("invalid value for 'owned_limit', owned_limit cannot be nil.")
      end
    ...
    def valid?
      return false if @active_only.nil?
      return false if @owned_limit.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          active_only == o.active_only &&
          name == o.name &&
          owned_limit == o.owned_limit
    end
    ...
    def hash
      [active_only, name, owned_limit].hash
    end
