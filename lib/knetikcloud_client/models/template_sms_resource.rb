...
module KnetikCloudClient
  ...
  class TemplateSMSResource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'localizer')
        self.localizer = attributes[:'localizer']
      end
    ...
    def list_invalid_properties
      ...
      if @template_key.nil?
        invalid_properties.push("invalid value for 'template_key', template_key cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @template_key.nil?
      return true
    end
    ...
    def hash
      [from, localizer, recipients, template_key, template_vars].hash
    end
