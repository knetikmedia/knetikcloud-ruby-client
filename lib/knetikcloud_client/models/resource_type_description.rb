...
module KnetikCloudClient
  ...
  class ResourceTypeDescription
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'id_field')
    ...
    def list_invalid_properties
      ...
      if @id_field.nil?
        invalid_properties.push("invalid value for 'id_field', id_field cannot be nil.")
      end
      ...
      if @service_path.nil?
        invalid_properties.push("invalid value for 'service_path', service_path cannot be nil.")
      end
    ...
    def valid?
      return false if @id_field.nil?
      return false if @name.nil?
      return false if @service_path.nil?
      return true
    end
    ...
    def hash
      [id_field, name, service_path].hash
    end
