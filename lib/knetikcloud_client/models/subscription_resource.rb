...
module KnetikCloudClient
  ...
  class SubscriptionResource
    ...
    def hash
      [additional_properties, availability, behaviors, category, consolidation_day_of_month, created_date, displayable, geo_country_list, geo_policy_type, id, long_description, name, plans, short_description, sort, store_end, store_start, tags, template, unique_key, updated_date, vendor_id].hash
    end
